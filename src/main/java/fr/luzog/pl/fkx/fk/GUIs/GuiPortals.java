...
public class GuiPortals {
    ...
    public static ItemStack getMainItem(String lastLoreLine, String command) {
        ...
        return Items.builder(Material.ENDER_PORTAL_FRAME)
                ...
                .setLore(
                        ...
                        " ",
                        "  §dNether :  " + (FKManager.getCurrentGame().getNether().isOpened() ?
                                "§2§l" + SpecialChars.YES + "§2  Ouvert" : "§4§l" + SpecialChars.NO + "§4  Fermé"),
                        " ",
                        "  §5End :  " + (FKManager.getCurrentGame().getEnd().isOpened() ?
                                "§2§l" + SpecialChars.YES + "§2  Ouvert" : "§4§l" + SpecialChars.NO + "§4  Fermé"),
                        " ",
                        "§8" + Guis.loreSeparator
                                + (lastLoreLine == null ? "" : "\n§7" + lastLoreLine)
    ...
    public static Inventory getMainInventory(String back) {
        ...
        Inventory inv = Guis.getBaseInventory("§dPortails", 54, back,
                getMainItem("Clic pour rafraîchir", "fk portal"), null);

        // "Clic pour voir plus\n \n§7Commande :\n§7/fk zone " + z.getId()

        Utils.fill(inv, Utils.posOf(1, 1), Utils.posOf(3, 3), false, getSideItem(
                PortalType.NETHER, "§7Commande :\n§7/fk portal nether", "fk portal nether"));
        inv.setItem(Utils.posOf(2, 2), getPortalItem(FKManager.getCurrentGame().getNether(),
                PortalType.NETHER, "§7Commande :\n§7/fk portal nether", "fk portal nether"));

        Utils.fill(inv, Utils.posOf(5, 2), Utils.posOf(7, 4), false, getSideItem(
                PortalType.END, "§7Commande :\n§7/fk portal end", "fk portal end"));
        inv.setItem(Utils.posOf(6, 3), getPortalItem(FKManager.getCurrentGame().getEnd(),
                PortalType.END, "§7Commande :\n§7/fk portal end", "fk portal end"));
    ...
    public static Inventory getPortalInventory(Portal p, PortalType t, Location from, String back) {
        ...
        String refresh = "fk portal " + t.name();
        ...
        inv.setItem(Utils.posOf(4, 3), Items.builder(Material.NETHER_STAR)
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " §8(§2open §8|§4 close§8)"
                )
                .setLeftRightCommandOnClick(
                        "fk portal " + t.name() + " " + (p.isOpened() ? "close" : "open") + "\n" + refresh,
                        refresh
                )
                .setCantClickOn(true)
                .build());
        inv.setItem(Utils.posOf(3, 4), Items.builder(Material.WATCH)
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " cooldown §f<délai>"
                )
                .setLeftRightShiftCommandOnClick(
                        "fk portal " + t.name() + " cooldown " + ((p.getCoolDown() / 20.0) + 1) + "\n" + refresh,
                        "fk portal " + t.name() + " cooldown " + ((p.getCoolDown() / 20.0) + 5) + "\n" + refresh,
                        "fk portal " + t.name() + " cooldown " + Math.max((p.getCoolDown() / 20.0) - 1, 0.05) + "\n" + refresh,
                        "fk portal " + t.name() + " cooldown " + Math.max((p.getCoolDown() / 20.0) - 5, 0.05) + "\n" + refresh
                )
                .setMiddleCommandOnClick("input 1 fk portal " + t.name() + " cooldown %s%n" + refresh)
                .setCantClickOn(true)
                .build());
        inv.setItem(Utils.posOf(5, 4), Items.builder(Material.BRICK)
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " closingMat §f<materiel>",
                        "§7/fk portal " + t.name() + " openingMat §f<materiel>",
                        "§7/fk portal " + t.name() + " data §f<data>"
                )
                .setLeftRightCommandOnClick(
                        "input 1 fk portal " + t.name() + " closingMat %s%n" + refresh,
                        "input 1 fk portal " + t.name() + " openingMat %s%n" + refresh
                )
                .setMiddleCommandOnClick("input 1 fk portal " + t.name() + " data %s%n" + refresh)
                .setCantClickOn(true)
                .build());
        ...
        inv.setItem(Utils.posOf(1, 1), Items.builder(Material.GRASS)
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " over pos1 set §f<x> <y> <z> §8[§f<world>§8]",
                        "§7/fk portal " + t.name() + " over pos1 reset"
                )
                .setLeftRightShiftCommandOnClick(
                        ...
                        refresh,
                        from == null ? "null" : "fk portal " + t.name() + " over pos1 set " + from.getX()
                                + " " + from.getY() + " " + from.getZ() + " " + from.getWorld().getName() + "\n" + refresh,
                        "fk portal " + t.name() + " over pos1 reset\n" + refresh
                )
                .setMiddleCommandOnClick("input 4 fk portal " + t.name() + " over pos1 set %s %s %s %s%nfk portal " + t.name())
                .setCantClickOn(true)
                .build());
        inv.setItem(Utils.posOf(1, 3), Items.builder(Material.GRASS)
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " over pos2 set §f<x> <y> <z> §8[§f<world>§8]",
                        "§7/fk portal " + t.name() + " over pos2 reset"
                )
                .setLeftRightShiftCommandOnClick(
                        p.getOverPortal2() == null ? "null"
                        ...
                        refresh,
                        from == null ? "null" : "fk portal " + t.name() + " over pos2 set " + from.getX()
                                + " " + from.getY() + " " + from.getZ() + " " + from.getWorld().getName() + "\n" + refresh,
                        "fk portal " + t.name() + " over pos2 reset\n" + refresh
                )
                .setMiddleCommandOnClick("input 4 fk portal " + t.name() + " over pos2 set %s %s %s %s%nfk portal " + t.name())
                .setCantClickOn(true)
                .build());
        inv.setItem(Utils.posOf(2, 2), Items.builder(Material.WOOD)
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " over spawn set §f<x> <y> <z>  §8[§f<yw> <pi>§8] [§f<world>§8]",
                        "§7/fk portal " + t.name() + " over spawn reset"
                )
                .setLeftRightShiftCommandOnClick(
                        ...
                        refresh,
                        from == null ? "null" : "fk portal " + t.name() + " over spawn set " + from.getX()
                                + " " + from.getY() + " " + from.getZ() + " " + from.getYaw()
                                + " " + from.getPitch() + " " + from.getWorld().getName() + "\n" + refresh,
                        "fk portal " + t.name() + " over spawn reset\n" + refresh
                )
                .setMiddleCommandOnClick("input 6 fk portal " + t.name() + " over spawn set %s %s %s %s %s %s%nfk portal " + t.name())
                .setCantClickOn(true)
                .build());
        ...
        inv.setItem(Utils.posOf(7, 1), Items.builder(t.getSec())
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " dim pos1 set §f<x> <y> <z> §8[§f<world>§8]",
                        "§7/fk portal " + t.name() + " dim pos1 reset"
                )
                .setLeftRightShiftCommandOnClick(
                        ...
                        refresh,
                        from == null ? "null" : "fk portal " + t.name() + " dim pos1 set " + from.getX()
                                + " " + from.getY() + " " + from.getZ() + " " + from.getWorld().getName() + "\n" + refresh,
                        "fk portal " + t.name() + " dim pos1 reset\n" + refresh
                )
                .setMiddleCommandOnClick("input 4 fk portal " + t.name() + " dim pos1 set %s %s %s %s%nfk portal " + t.name())
                .setCantClickOn(true)
                .build());
        inv.setItem(Utils.posOf(7, 3), Items.builder(t.getSec())
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " dim pos2 set §f<x> <y> <z> §8[§f<world>§8]",
                        "§7/fk portal " + t.name() + " dim pos2 reset"
                )
                .setLeftRightShiftCommandOnClick(
                        ...
                        refresh,
                        from == null ? "null" : "fk portal " + t.name() + " dim pos2 set " + from.getX()
                                + " " + from.getY() + " " + from.getZ() + " " + from.getWorld().getName() + "\n" + refresh,
                        "fk portal " + t.name() + " dim pos2 reset\n" + refresh
                )
                .setMiddleCommandOnClick("input 4 fk portal " + t.name() + " dim pos2 set %s %s %s %s%nfk portal " + t.name())
                .setCantClickOn(true)
                .build());
        inv.setItem(Utils.posOf(6, 2), Items.builder(t.getTer())
                ...
                .setLore(
                        ...
                        " ",
                        "§7Commande :",
                        "§7/fk portal " + t.name() + " dim spawn set §f<x> <y> <z>  §8[§f<yw> <pi>§8] [§f<world>§8]",
                        "§7/fk portal " + t.name() + " dim spawn reset"
                )
                .setLeftRightShiftCommandOnClick(
                        ...
                        refresh,
                        from == null ? "null" : "fk portal " + t.name() + " dim spawn set " + from.getX()
                                + " " + from.getY() + " " + from.getZ() + " " + from.getYaw()
                                + " " + from.getPitch() + " " + from.getWorld().getName() + "\n" + refresh,
                        "fk portal " + t.name() + " dim spawn reset\n" + refresh
                )
                .setMiddleCommandOnClick("input 6 fk portal " + t.name() + " dim spawn set %s %s %s %s %s %s%nfk portal " + t.name())
                .setCantClickOn(true)
                .build());
